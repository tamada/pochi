...
import com.github.ebis.scripts.helper.BirthmarkSystemHelper;
import com.github.ebis.scripts.helper.IOHelper;
import com.github.ebis.scripts.helper.SystemInfoHelper;
...
public class ScriptRunner {
    ...
    private void runInteractiveMode(LineReader reader){
        ...
        String line;
        while((line = reader.readLine("ebis> ")) != null){
            try{
