...
import jp.cafebabe.pochi.nasubi.Exceptions;
import jp.cafebabe.pochi.nasubi.ServiceLoader;
import jp.cafebabe.pochi.nasubi.ServiceLoaderBuilder;
import jp.cafebabe.pochi.nasubi.spi.NoDefaultConstructorService;
import jp.cafebabe.pochi.nasubi.spi.NoDescriptionService;
import jp.cafebabe.pochi.nasubi.spi.NoImplementationService;
import jp.cafebabe.pochi.nasubi.spi.Service;
...
public class ServiceLoaderTest {
    ...
    public void testLoadSuccess(){
        ...
        assertThat(list.get(0).getClass().getName(), is("jp.cafebabe.pochi.nasubi.spi.ServiceImpl1"));
        assertThat(list.get(0).name(), is("service1"));

        assertThat(list.get(1).getClass().getName(), is("jp.cafebabe.pochi.nasubi.spi.ServiceImpl2"));
        assertThat(list.get(1).name(), is("service2"));

        assertThat(list.get(2).getClass().getName(), is("jp.cafebabe.pochi.nasubi.spi.ServiceImpl3"));
    ...
    public void testInstantiateWithFunction(){
        ...
        assertThat(list.get(0).getClass().getName(), is("jp.cafebabe.pochi.nasubi.spi.NoDefaultConstructorServiceImpl1"));
        assertThat(list.get(0).type(), is("service2-1"));
        assertThat(list.get(0).string(), is("string"));

        assertThat(list.get(1).getClass().getName(), is("jp.cafebabe.pochi.nasubi.spi.NoDefaultConstructorServiceImpl2"));
