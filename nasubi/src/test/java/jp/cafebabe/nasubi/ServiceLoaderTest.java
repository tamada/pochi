...
import jp.cafebabe.nasubi.spi.NoDefaultConstructorService;
import jp.cafebabe.nasubi.spi.NoDescriptionService;
import jp.cafebabe.nasubi.spi.NoImplementationService;
import jp.cafebabe.nasubi.spi.Service;
...
public class ServiceLoaderTest {
    ...
    public void testLoadSuccess(){
        ...
        assertThat(list.get(0).getClass().getName(), is("jp.cafebabe.nasubi.spi.ServiceImpl1"));
        assertThat(list.get(0).name(), is("service1"));

        assertThat(list.get(1).getClass().getName(), is("jp.cafebabe.nasubi.spi.ServiceImpl2"));
        assertThat(list.get(1).name(), is("service2"));

        assertThat(list.get(2).getClass().getName(), is("jp.cafebabe.nasubi.spi.ServiceImpl3"));
    ...
    public void testInstantiateWithFunction(){
        ...
        assertThat(list.get(0).getClass().getName(), is("jp.cafebabe.nasubi.spi.NoDefaultConstructorServiceImpl1"));
        assertThat(list.get(0).type(), is("service2-1"));
        assertThat(list.get(0).string(), is("string"));

        assertThat(list.get(1).getClass().getName(), is("jp.cafebabe.nasubi.spi.NoDefaultConstructorServiceImpl2"));
