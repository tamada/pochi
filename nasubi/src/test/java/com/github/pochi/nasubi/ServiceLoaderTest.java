...
public class ServiceLoaderTest {
    ...
    public void testLoadSuccess(){
        ...
        assertThat(list.get(1).getClass().getName(), is("com.github.pochi.nasubi.spi.ServiceImpl2"));
        assertThat(list.get(1).name(), is("service2"));

        assertThat(list.get(2).getClass().getName(), is("com.github.pochi.nasubi.spi.ServiceImpl3"));
    ...
    public void testInstantiateWithFunction(){
        ...
        assertThat(list.get(0).getClass().getName(), is("com.github.pochi.nasubi.spi.NoDefaultConstructorServiceImpl1"));
        assertThat(list.get(0).type(), is("service2-1"));
        assertThat(list.get(0).string(), is("string"));

        assertThat(list.get(1).getClass().getName(), is("com.github.pochi.nasubi.spi.NoDefaultConstructorServiceImpl2"));
