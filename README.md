...
[![Version](https://img.shields.io/badge/Version-2.4.4-green.svg)](https://github.com/tamada/pochi/releases/tag/v2.4.4)
[![DOI](https://img.shields.io/badge/DOI-10.5281/zenodo.4271132-green.svg)](https://zenodo.org/badge/latestdoi/82773287)

[![Javadoc](https://img.shields.io/badge/Javadoc-v2.4.4-blue?logo=java)](https://tamada.github.io/pochi/apidocs)
[![Docker](https://img.shields.io/badge/Docker-ghcr.io%2Ftamada%2Fpochi%3A2.4.4-blue?logo=docker)](https://github.com/users/tamada/packages/container/package/pochi)
...
[![Docker](https://img.shields.io/badge/Docker-ghcir.io%2Ftamada%2Fpochi%3A2.4.4-blue?logo=docker)](https://github.com/users/tamada/packages/container/package/pochi)
...
|--------------------|--------------|---------|
|`jp.cafebabe.pochi` | `kunai2`     | `2.4.4` |
|`jp.cafebabe.pochi` | `pochi-core` | `2.4.4` |
|`jp.cafebabe.pochi` | `pochi-api`  | `2.4.4` |
|`jp.cafebabe.pochi` | `pochi-cmd`  | `2.4.4` |
